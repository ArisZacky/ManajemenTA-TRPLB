  ...
  <main id="main" class="main">
    ...
    <section class="section dashboard">
      ...
      <div class="w3-panel w3-blue w3-display-container">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Data Bimbingan Tugas Akhir</h5>
              <!-- Default Table -->
              <table class="table">
                <thead>
                  <tr>
                ...
                <tbody>
                  <?php 
                    ...
                    <tr>
                      ...
                      <td>
                          <a href="<?php echo base_url('dosen/CBimbingan/downloadFileBimbingan/'.$row->idBimbingan); ?>" target="__blank"><?php echo $row->berkasBimbingan ?></a>
                      </td>
                      <td>
                        <?php echo $row->keteranganRevisi ?>
                      </td>
                      <td>
                        <a class="btn btn-success" href="<?php echo base_url('dosen/CBimbingan/prosesBimbingan/'.$row->idBimbingan);?>">Terima Bimbingan</a>
                      </td>
                    </tr>
                  <?php 
                    $no++;
