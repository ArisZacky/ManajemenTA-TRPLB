...
<head>
    <title>Surat Jadwal Ujian Tugas Akhir</title>
    <style>
...
<body>
    ...
    <div class="surat">
        ...
        <p>Hal: Jadwal Ujian Tugas Akhir</p>
        ...
        <p>Menginformasikan kepada Mahasiswa mengenai pelaksanaan Ujian Tugas Akhir 
            di Politeknik Negeri Bali diatur dan dilaksanakan sebagai berikut:
        </p>

        <p>
            1. Pelaksanaan Ujian Tugas Akhir Politeknik Negeri Bali dilaksanakan secara luring di area kampus Politeknik Negeri Bali.
        </p>
        <p>
            2. Pastikan Mahasiswa dapat menghadiri agenda Ujian Tugas Akhir dengan tepat waktu.
        </p>
        <p>
            3. Pelaksanaan Ujian Tugas Akhir diatur sesuai jadwal:
        </p>
