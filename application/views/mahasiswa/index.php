...
<body>
  ...
  <main id="main" class="main">
    ...
    <section class="section dashboard">
      <div class="row">
        <h1>INI HALAMAN UNTUK MAHASISWA!</h1>
      </div>
    </section>
  ...
  <!-- Vendor JS Files -->
  <script src="<?php base_url() ?>assets/vendor/apexcharts/apexcharts.min.js"></script>
  <script src="<?php base_url() ?>assets/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
  <script src="<?php base_url() ?>assets/vendor/chart.js/chart.umd.js"></script>
  <script src="<?php base_url() ?>assets/vendor/echarts/echarts.min.js"></script>
  <script src="<?php base_url() ?>assets/vendor/quill/quill.min.js"></script>
  <script src="<?php base_url() ?>assets/vendor/simple-datatables/simple-datatables.js"></script>
  <script src="<?php base_url() ?>assets/vendor/tinymce/tinymce.min.js"></script>
