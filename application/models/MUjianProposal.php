...
public function rulesRevisi()
{
    ...
    public function getById($idUjianProposal)
    {
        return $this->db->get_where("ujianProposal", ["idUjianProposal" => $idUjianProposal])->row();
    }
    ...
    public function outputProsesDetailKaprodi($idUjianProposal)
    {
        ...
        $this->db->join('dosen as dosen3', 'ujianProposal.penguji3 = dosen3.NIP');
        $this->db->join('dosen as dosen4', 'pengajuanProposal.pembimbing1 = dosen4.NIP');
        $this->db->where('ujianproposal.idUjianProposal', $idUjianProposal);
        // $this->db->where('dosen1.NIP', 'ujianProposal.penguji1');  
        // $this->db->where('dosen2.NIP', 'ujianProposal.penguji2');
        // $this->db->where('dosen3.NIP', 'ujianProposal.penguji3');  
    ...
    public function outputProsesKaprodi($idUjianProposal)
    {
        $this->db->select("*");
        $this->db->from('ujianProposal');
        $this->db->join('pengajuanProposal', 'ujianProposal.idProposal = pengajuanProposal.idProposal');
    ...
    {
        $post = $this->input->post();
        $this->idUjianProposal = $post["idUjianProposal"];
        // $this->NIM = $post["NIM"];
    ...
    public function delete($idUjianProposal)
    {
        return $this->db->delete('ujianProposal', array("idUjianProposal" => $idUjianProposal));
    }
}
